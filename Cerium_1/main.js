...
function main() {
    ...
    const axisFormula = "PN[R4E0]NPNNPNNPN[R4E0]NPNNPNNPN[R4E0]NPNNPNNPN[R4E0]NPNNPNNPNNPNNPNNPN[R4E0]NPNNPNNPN[R4E0]NPNNPNNPN[R4E0]NPNNPNNPN[R4E0]NP";
    const cameraDistance = parseFloat("225") || 40;
    const title = "58";
