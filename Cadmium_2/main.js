...
function main() {
    ...
    const axisFormula = "PN[R4E0]NNPNNPN[R4E0]NPNNPN[R4E0]NPNNPN[R4E0]NPNNPN[R4E0]NPNNPN[R4E0]NPNNPN[R4E0]NPNNPN[R4E0]NNP";
    const cameraDistance = parseFloat("117") || 40;
    const title = "48";
