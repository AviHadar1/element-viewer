...
function main() {
    ...
    const axisFormula = "PN[R8N8E-1]N[R8N8E-0.3]PN[R8N8E0.4]N[R1N4E1]PN[R0N6E0]N[R0N6E0]PN[R0N4E-1]N[R8N8E-0.4]PN[R8N8E0.3]N[R8N8E1]P";
    const cameraDistance = parseFloat("40") || 40;
    const title = "Cesium 55   Cs-133";
