...
function main() {
    ...
    const axisFormula = "PN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPNNPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NP";
    const cameraDistance = parseFloat("333") || 40;
    const title = "74";
