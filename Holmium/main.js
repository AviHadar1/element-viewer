...
function main() {
    ...
    const axisFormula = "PN[R8N8E-1]N[R8N8E-0.3]PN[R8N8E0.4]N[R6N8E1]PN[R0N7E0]N[R0N4E0]PN[R0N4E0]N[R0N7E0]PN[R6N8E-1]N[R8N8E-0.4]PN[R8N8E0.3]N[R8N8E1]P";
    const cameraDistance = parseFloat("45") || 40;
    const title = "Holmium 67   Ho-165";
