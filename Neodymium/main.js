...
function main() {
    ...
    const axisFormula = "PN[R3E0]NNPN[R3E0]NPN[R3E0]NPN[R3E0]NPN[R3E0]NPN[R3E0]NPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNN[R3E-30][R3E-18][R3E-6][R3E6][R3E18][R3E30]NP";
    const cameraDistance = parseFloat("99.5") || 50;
    const title = "60";
