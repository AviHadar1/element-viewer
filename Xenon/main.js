...
function main() {
    ...
    const axisFormula = "PN[R2E0]NNPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPNNPNNPNNPNNPNNPNNPNNPNNPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NP";
    const cameraDistance = parseFloat("125") || 50;
    const title = "54";
