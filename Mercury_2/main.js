...
function main() {
    ...
    const axisFormula = "PN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NP";
    const cameraDistance = parseFloat("387") || 40;
    const title = "80";
