...
function main() {
    ...
    const axisFormula = "PN[R4E0]NPN[R4E0]NPN[R4E0]NPN[R4E0]NPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPN[R4E0]NPN[R4E0]NPN[R4E0]NPN[R4E0]NP";
    const cameraDistance = parseFloat("102.5") || 50;
    const title = "58";
