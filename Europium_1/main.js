...
function main() {
    ...
    const axisFormula = "PN[R5E0]NPNNPNNPNNPNNPN[R5E0]NPNNPNNPNNPNNPN[R5E0]NPNNPNNPN[R5E0]NPNNPNNPN[R5E0]NPNNPNNPNNPNNPN[R5E0]NPNNPNNPNNPNNPN[R5E0]NP";
    const cameraDistance = parseFloat("243") || 40;
    const title = "63";
