...
function main() {
    ...
    const axisFormula = "PN[R4E0]NPNNPN[R4E0]NPNNPN[R4E0]NPNNPN[R4E0]NPNNPN[R4E0]NPNNPNNPNNPNNPNNPNNPNNPNNPN[R4E0]NPNNPN[R4E0]NPNNPN[R4E0]NPNNPN[R4E0]NP";
    const cameraDistance = parseFloat("168") || 40;
    const title = "61";
