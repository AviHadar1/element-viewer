...
function main() {
    ...
    const axisFormula = "PN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPNNPNNPNNPNNPNNPNNPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NP";
    const cameraDistance = parseFloat("234") || 40;
    const title = "57";
