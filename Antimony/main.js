...
function main() {
    ...
    const axisFormula = "PN[R2E0]NNPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPNNPNNPNNPNNPNNPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NP";
    const cameraDistance = parseFloat("111.5") || 50;
    const title = "51";
