...
function main() {
    ...
    const axisFormula = "PN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPNNPNNPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NP";
    const cameraDistance = parseFloat("198") || 40;
    const title = "53";
