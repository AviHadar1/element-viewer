...
function main() {
    ...
    const axisFormula = "PN[R8N8E-1]N[R8N8E-0.3]PN[R8N8E0.4]N[R2N6E1]PN[R0N6E0]N[R0N6E0]PN[R1N6E-1]N[R8N8E-0.4]PN[R8N8E0.3]N[R8N8E1]P";
    const cameraDistance = parseFloat("40") || 40;
    const title = "Lanthanum 57   La-139";
