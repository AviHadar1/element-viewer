...
function main() {
    ...
    const axisFormula = "PN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPNNPNNPNNPNNPNNPNNPNNPNNPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NPNNPN[R3E0]NP";
    const cameraDistance = parseFloat("270") || 40;
    const title = "64";
