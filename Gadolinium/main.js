...
function main() {
    ...
    const axisFormula = "PN[R8N8E-1]N[R8N8E-0.3]PN[R8N8E0.4]N[R5N8E1]PN[R0N7E0]N[R0N2E0]PN[R0N2E0]N[R0N7E0]PN[R4N7E-1]N[R8N8E-0.4]PN[R8N8E0.3]N[R8N8E1]P";
    const cameraDistance = parseFloat("45") || 40;
    const title = "Gadolinium 64   Gd-157";
