...
function main() {
    ...
    const axisFormula = "PN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPNNPNNPNNPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NPN[R2E0]NP";
