...
function main() {
    ...
    const axisFormula = "PN[R1E0]NPN[R1E0]NPN[R1E0]NPN[R1E0]NPN[R1E0]NPN[R1E0]NPN[R1E0]NPN[R1E0]NPN[R1E0]NPN[R1E0]NPN[R1E0]NPN[R1E0]NPN[R1E0]NPN[R1E0]NPN[R1E0]NP";
