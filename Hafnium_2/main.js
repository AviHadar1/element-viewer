...
function main() {
    ...
    const axisFormula = "PN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NPNNPNNPN[R3E0]NP";
    const cameraDistance = parseFloat("315") || 40;
    const title = "72";
